...
export function Ocean() {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uDepthColor: { value: new THREE.Color('#4a90c2') },
      uSurfaceColor: { value: new THREE.Color('#e8f4fc') },
      uColorOffset: { value: 0.1 },
      uColorMultiplier: { value: 3 },
      uFogColor: { value: new THREE.Color('#f0f8ff') },
      uFogNear: { value: 5 },
      uFogFar: { value: 30 },
    }),
    []
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Add subtle foam at peaks
      float foam = smoothstep(0.08, 0.15, vElevation);
